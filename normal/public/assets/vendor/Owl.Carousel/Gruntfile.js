...
module.exports = function(grunt) {
		...
		.initConfig({
			...
			assemble: {
				options: {
					...
					expand: true,
					production: false,
					./public/assets: '<%= app.docs.dest %>/./public/assets',
			...
			sass: {
				docs: {
					options: {
						...
						includePaths: [ '<%= app.docs.src %>/./public/assets/scss/', 'node_modules/foundation-sites/scss' ]
					},
					files: {
						'<%= app.docs.dest %>/./public/assets/css/docs.theme.min.css': '<%= app.docs.src %>/./public/assets/scss/docs.theme.scss'
					}
				},
				dist: {
					options: {
					...
					files: {
						'dist/./public/assets/<%= pkg.name %>.css': 'src/scss/<%= pkg.name %>.scss',
						'dist/./public/assets/owl.theme.default.css': 'src/scss/owl.theme.default.scss',
						'dist/./public/assets/owl.theme.green.css': 'src/scss/owl.theme.green.scss'
					}
				}
			},
			...
			autoprefixer: {
				...
				dist: {
					files: {
						'dist/./public/assets/<%= pkg.name %>.css': 'dist/./public/assets/<%= pkg.name %>.css',
						'dist/./public/assets/owl.theme.default.css': 'dist/./public/assets/owl.theme.default.css',
						'dist/./public/assets/owl.theme.green.css': 'dist/./public/assets/owl.theme.green.css'
					}
				}
			},
			...
			cssmin: {
				dist: {
					files: {
						'dist/./public/assets/<%= pkg.name %>.min.css': 'dist/./public/assets/<%= pkg.name %>.css',
						'dist/./public/assets/owl.theme.default.min.css': 'dist/./public/assets/owl.theme.default.css',
						'dist/./public/assets/owl.theme.green.min.css': 'dist/./public/assets/owl.theme.green.css'
					}
				}
			},
			...
			copy: {
				...
				distToDocs: {
					...
					cwd: 'dist/',
					src: [ '**/*.*' ],
					dest: '<%= app.docs.dest %>/./public/assets/owlcarousel'
				},
				...
				srcToDocs: {
					...
					cwd: 'src/js',
					src: [ '**/*.js' ],
					dest: '<%= app.docs.dest %>/./public/assets/owlcarousel/src'
				},

				docs./public/assets: {
					expand: true,
					cwd: '<%= app.docs.src %>/./public/assets/',
					src: [ 'css/*.css', 'vendors/*.js', 'vendors/*.map', 'img/*.*', 'js/*.*' ],
					dest: '<%= app.docs.dest %>/./public/assets/'
				},
			...
			watch: {
				...
				sassDocs: {
					files: [ '<%= app.docs.src %>/./public/assets/**/*.scss' ],
					tasks: [ 'sass:docs' ]
				},
				sass: {
					files: [ 'src/**/*.scss' ],
				...
				jsDocs: {
					files: [ '<%= app.docs.src %>/./public/assets/**/*.js' ],
					tasks: [ 'copy:docs./public/assets' ]
				},
				js: {
					files: [ 'src/**/*.js' ],
	...
	grunt.registerTask('docs', [ 'dist', 'clean:docs', 'assemble', 'sass:docs', 'copy:docs./public/assets', 'copy:distToDocs', 'zip' ]);
